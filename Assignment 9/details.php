...
// DB Connection
	...
	$sql = "SELECT title, release_date, award, labels.label AS label, sounds.sound AS sound, genres.genre AS genre, ratings.rating AS rating, formats.format AS format
					FROM dvd_titles
					LEFT JOIN labels
